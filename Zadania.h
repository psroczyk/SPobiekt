...
int blokada1 = 0, blokada2 = 0, blokada3 = 0,blokada4 = 0, blokada5 = 0, blokada6 = 0, blokada7 = 0, blokada8 = 0;
int przyciskniedostepny1 = 0, przyciskniedostepny2 = 0, przyciskniedostepny3 = 0, przyciskniedostepny4 = 0;
int przyciskniedostepny5 = 0, przyciskniedostepny6 = 0, przyciskniedostepny7 = 0, przyciskniedostepny8 = 0;
int liczZ1 = 0, liczZ2 = 0, liczZ3 = 0, liczZ4 = 0, liczZ5 = 0, liczZ6 = 0, liczZ7 = 0, liczZ8 = 0;
float liczA2Z1 = 0, liczA2Z3 = 0, liczA2Z5 = 0, liczA2Z7 = 0;
volatile int tim1 = 0, tim2 = 3 * sek, tim3 = 0, tim4 = 0, timNOC = 0, timLCD = 0, timPom = 4 * sek;
int T1 = 4 * sek, Tprzerwa = 5 * sek, T2 = 8 * sek, T3 = 8 * sek, T4 = 8 * sek, T5 = 8 * sek, T6 = 8 * sek, T7 = 8 * sek, T8 = 8 * sek;
char pX2, pX5, pX1, pX6, pX8, pX3, pX4, pX7, pX9, pX10, pX11, pX12, pX13, pX14, pX15, pX16;

void zliczaj() {
	if (liczZ1 > 0 && pX11 && !X11)--liczZ1;
	if (liczZ2 > 0 && pX10 && !X10)--liczZ2;
	if (liczZ3 > 0 && pX12 && !X12)--liczZ3;
	if (liczZ4 > 0 && pX11 && !X11)--liczZ4;
	if (liczZ5 > 0 && pX9 && !X9)--liczZ5;
	if (liczZ6 > 0 && pX12 && !X12)--liczZ6;
	if (liczZ7 > 0 && pX10 && !X10)--liczZ7;
